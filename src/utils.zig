...
pub fn byteArrToInt(byte_arr: *const [4]u8) u32 {
    // TODO: there has to be a better way to do this lmao
    const size: u32 = ((@as(u32, @intCast(byte_arr[0])) << 24) |
...
// TODO: find some way to make this table static
// and or comptime-calculated
...
// computes the crc32 value of an array of bytes
...
pub fn Matrix(T: anytype) type {
    return struct {
        ...
        /// print only defined for matrices of raylib colors
        pub fn print(self: Self) void {
            ...
            for (self.data, 0..) |c, i| {
                ...
                std.debug.print("[{d},{d},{d}] ", .{c.r, c.g, c.b});
            }
            std.debug.print("\n]\n", .{});
        }
    };
